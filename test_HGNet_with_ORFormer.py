...
from Model.StackedHGNetV1 import StackedHGNetV5
...
def main_function():
    ...
    if args.dataset == "WFLW":
        model = StackedHGNetV5(classes_num=[cfg.WFLW.NUM_POINT, cfg.WFLW.NUM_EDGE, cfg.WFLW.NUM_POINT], 
    ...
    if args.dataset == "300W":
        model = StackedHGNetV5(classes_num=[cfg.W300.NUM_POINT, cfg.W300.NUM_EDGE, cfg.W300.NUM_POINT],
    ...
    if args.dataset == "COFW":
        model = StackedHGNetV5(classes_num=[cfg.COFW.NUM_POINT, cfg.COFW.NUM_EDGE, cfg.COFW.NUM_POINT],
